...
test.describe('Z. Service Worker cache upgrade', () => {
  test('app-shell cache surumu v20 olarak yenilenmistir', () => {
    expect(swMetni).toContain("const CACHE = 'isg-saha-v20';");
    expect(swMetni).not.toContain("const CACHE = 'isg-saha-v19';");
  });
