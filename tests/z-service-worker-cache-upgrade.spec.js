...
test.describe('Z. Service Worker cache upgrade', () => {
  test('app-shell cache surumu v17 olarak yenilenmistir', () => {
    expect(swMetni).toContain("const CACHE = 'isg-saha-v17';");
    expect(swMetni).not.toContain("const CACHE = 'isg-saha-v16';");
  });
