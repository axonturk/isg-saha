...
test.describe('Z. Service Worker cache upgrade', () => {
  test('app-shell cache surumu v26 olarak yenilenmistir', () => {
    expect(swMetni).toContain("const CACHE = 'isg-saha-v26';");
    expect(swMetni).not.toContain("const CACHE = 'isg-saha-v25';");
  });
