...
test.describe('Z. Service Worker cache upgrade', () => {
  test('app-shell cache surumu v28 olarak yenilenmistir', () => {
    expect(swMetni).toContain("const CACHE = 'isg-saha-v28';");
    expect(swMetni).not.toContain("const CACHE = 'isg-saha-v27';");
  });
