...
test.describe('Z. Service Worker cache upgrade', () => {
  test('app-shell cache surumu v29 olarak yenilenmistir', () => {
    expect(swMetni).toContain("const CACHE = 'isg-saha-v29';");
    expect(swMetni).not.toContain("const CACHE = 'isg-saha-v28';");
  });
