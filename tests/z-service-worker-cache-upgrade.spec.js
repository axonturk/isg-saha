...
test.describe('Z. Service Worker cache upgrade', () => {
  test('app-shell cache surumu v23 olarak yenilenmistir', () => {
    expect(swMetni).toContain("const CACHE = 'isg-saha-v23';");
    expect(swMetni).not.toContain("const CACHE = 'isg-saha-v22';");
  });
