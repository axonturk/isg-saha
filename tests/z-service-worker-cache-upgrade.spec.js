...
test.describe('Z. Service Worker cache upgrade', () => {
  test('app-shell cache surumu v31 olarak yenilenmistir', () => {
    expect(swMetni).toContain("const CACHE = 'isg-saha-v31';");
    expect(swMetni).not.toContain("const CACHE = 'isg-saha-v30';");
  });
