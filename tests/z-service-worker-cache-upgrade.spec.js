...
test.describe('Z. Service Worker cache upgrade', () => {
  test('app-shell cache surumu v27 olarak yenilenmistir', () => {
    expect(swMetni).toContain("const CACHE = 'isg-saha-v27';");
    expect(swMetni).not.toContain("const CACHE = 'isg-saha-v26';");
  });
